set(archdetect_c_code "
#if defined(__arm__) || defined(__TARGET_ARCH_ARM) ||defined(ARM)||defined(arm)||defined(armeb)
...
#elif defined(__AVM2__)||defined(AVM2)
	#error cmake_ARCH avm2
	...
	set(tng_compiler clang)
	if TARGET_IPHONE_SIMULATOR==1
		#error cmake_ARCH iossimu
	#elif TARGET_OS_IPHONE == 1
		#error cmake_ARCH ios
#endif
...
set(tng_arc ${CMAKE_TARGET_ARCHITECTURES})