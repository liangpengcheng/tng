...
public:
	...
	ILboolean	Load(void*,int ,ILenum);
	...
	//void		GetDXTData(void *Buffer, ILuint BufferSize, ILenum DXTCFormat);
...
// void ilImage::GetDXTData(void *Buffer, ILuint BufferSize, ILenum DXTCFormat)
// {
// 	if (this->Id) {
// 		this->Bind();
// 		ilGetDXTCData(Buffer,BufferSize,DXTCFormat);
// 	}
// }
